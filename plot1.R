plot_1 <- function(){
    ...
    #initialise the histogram over Global Active Power
    hist(hhpc_data$Global_active_power,col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)", ylim = c(0,1200))
    #close the file
    dev.off()
}